...
# AI_ENABLED will be set later after environment variables are loaded
...
# AI Settings                                                                  #
################################################################################
AI_ENABLED = __get_boolean("PAPERLESS_AI_ENABLED", "YES")
if AI_ENABLED:
    INSTALLED_APPS.append("paperless_ai.apps.PaperlessAiConfig")
...
if DEBUG:
    print("🔥 PAPERLESS-NGX DEVELOPMENT MODE ACTIVE - Hot Reload Enabled")
